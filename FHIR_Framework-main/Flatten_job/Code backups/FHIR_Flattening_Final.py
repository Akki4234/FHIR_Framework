...
ERRORREFERENCE_COLUMN_MISSING = 2008
...
#python FHIR_Flattening_Final.py --input /workspaces/FHIR_Framework/FHIR_Framework-main/Input_data_files/org_aff/org_aff.json --output /workspaces/FHIR_Framework/FHIR_Framework-main/output/WMP.parquet --config /workspaces/FHIR_Framework/FHIR_Framework-main/Config_method2/orgaff_config.json